...
publication_class_count=$(grep -Fc -- '- Publication class: `public`.' docs/agent-harness.md || true)
[ "$publication_class_count" -eq 1 ] ||
  fail "docs/agent-harness.md must declare exactly one public publication class"
